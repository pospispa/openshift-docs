...
xref:../install_config/persistent_storage/storage_classes.adoc#install-config-persistent-storage-storage-classes[dynamic provisioning] of persistent storage volumes from Amazon EBS, Google Compute
