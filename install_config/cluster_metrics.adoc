...
If you would like to use xref:../install_config/persistent_storage/storage_classes.adoc#install-config-persistent-storage-storage-classes[dynamically provisioned persistent volumes]
...
xref:../install_config/persistent_storage/storage_classes.adoc#install-config-persistent-storage-storage-classes[dynamically provision persistent volumes].
...
|Set to *true* to allow for xref:../install_config/persistent_storage/storage_classes.adoc#install-config-persistent-storage-storage-classes[dynamically provisioned storage].
